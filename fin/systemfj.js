      ...
      if (Type.isTuple(v)) {
        ...
        switch (typeof v === "undefined" ? "undefined" : _typeof(v)) {
          ...
          case "boolean":
            return Type.Bool;
          case "function":
            return Type.FUNCTION; // ok, this is actually not good, since pattern matching won't work with curried functions this way
          case "object":
...
head = new Func("head").match("JList", function (_ref) {
...
tail = new Func("tail", Type.JList, Type.JList).match("JList", function (_ref3) {
...
realPart = new Func("realPart", Type.Complex, Type.Float).match("Complex", function (_ref7) {
...
imagPart = new Func("realPart", Type.Complex, Type.Float).match("Complex", function (_ref9) {
...
magnitude = new Func("magnitude", Type.Complex, Type.Float).match("Complex", function (_ref11) {
...
map = new Func("map", Type.FUNCTION, Type.List, Type.List).match(["Function", "Nil"], function () {
  return Nil();
}).match(["Function", "Cell"], function (f, _ref15) {
