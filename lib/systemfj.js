...
var BOTTOM, EMPTY, JBool, JFloat, JInt, JString, T, TOP, UNIT, Unit, id, imagPart, isZero, magnitude, realPart, runTests, show, toInt, tta, ttf,
...
imagPart = new Func("realPart", Type.Complex, Type.Float).match("Complex", function([x, y]) {
  return y;
}).ap;
...
runTests = function() {
  ...
  return console.log(show(id(two)));
};
