...
var T, f10, head, id, imagPart, isZero, length, magnitude, map, realPart, runTests, show, tail, testF, toInt,
  ...
  static checkType(v) {
    ...
    if (Type.isTuple(v)) {
      ...
      switch (typeof v) {
        ...
        case "object": // finding the name of the constructor for a standard JS object - useful for defining generic pattern matched functions
...
*/
export var TypeClass = class TypeClass {
  constructor(name1, ...varTypes) {
    var i, j, ref;
    this.name = name1;
    this.functions = {}; // functions against which we pattern match
...
head = new Func("head").match("JList", function([l]) {
  return l[0];
}).ap;

tail = new Func("tail", Type.JList, Type.JList).match("JList", function([l]) {
