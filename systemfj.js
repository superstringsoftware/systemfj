...
(function() {
  ...
  var Constructor, Func, T, Type, TypeVar, Value, Var, Variable, length, tBOTTOM, tCustom, tEither, tEmpty, tFloat, tInt, tList, tMaybe, tPair, tPeano, tString, tTOP, tUnit, two, z,
    ...
    new(...vals) {
      ...
      if (this.vars.length === 0) {
        ...
        for (i = j = 0, ref = this.vars.length; 0 <= ref ? j < ref : j > ref; i = 0 <= ref ? ++j : --j) {
          ...
          v = vals[i];
          if (v != null) {
            if (this.vars[i].type.equals(v._type_)) { // are the types ok?
